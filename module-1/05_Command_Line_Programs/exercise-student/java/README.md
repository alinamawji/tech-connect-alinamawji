...
1. [Import](https://book.techelevator.com/jpmc/content/guides/intellij.html#import-a-project) the command-line programs exercises project into IntelliJ.
...
3. [Run](https://book.techelevator.com/jpmc/content/guides/intellij.html#running-java-applications) the application to verify that it works as expected.
