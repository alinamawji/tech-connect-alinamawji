...
public class WordSearchTests {
    ...
    public void caseInsensitiveSearch_LineNumbers() throws IOException {
        ...
        List<Integer> expected = new ArrayList<>(Arrays.asList(683, 794, 1337, 1826, 2107, 2611, 2659));
    ...
    public void caseSensitiveSearch_LineNumbers() throws IOException {
        ...
        List<Integer> expected = new ArrayList<>(Arrays.asList(794, 1337, 1826, 2107, 2611));
