...
public class Exercises {
	...
	public String extraEnd(String str) {
		...
		String lastTwoLetters = str.substring(strLength-2, strLength);
	...
	public String nTwice(String str, int n) {
		...
		String substr2 = str.substring(strLength-n);
	...
	public String middleThree(String str) {
		...
		return str.substring(halfIndex-1, halfIndex+2);
	}
	...
	public boolean hasBad(String str) {
		if (str.length() > 3) {
			String substr0 = str.substring(0, 3);
			String substr1 = str.substring(1, 4);
			return ((substr0.equals("bad")) || (substr1.equals("bad")));
		} else {
	...
	public int last2(String str) {
		...
		if ((strLength == 0) || (strLength == 1) || (strLength == 2)) {
			...
			String origSubstr = str.substring(strLength-2);
